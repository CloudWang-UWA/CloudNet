...
class ADE20KDataset(Dataset):
    ...
    def get_crop_rcs(self, img, label_map, c):
        ...
        new_condition_img = label_map[y1:y2, x1:x2]
        new_texts = get_class_stacks(new_condition_img)
    ...
    def __getitem__(self, idx):
        if self.rcs_enabled:
            ...
            img_file = label_id_file.replace("_labelTrainIds.png", ".png").replace("labels", "images")
            ...
            # label_id_file = mask_file.replace(".png", "_labelTrainIds.png")
            label_id_file = mask_file
