...
CONTROLNET_MODEL_PATH="${CONTROLNET_MODEL_PATH:-$PROJECT_ROOT/cwang_model/controlnet_100_48000}"
...
IP_ADAPTER_PATH="${IP_ADAPTER_PATH:-$PROJECT_ROOT/ip_adapter_models/models/ip-adapter-plus_sd15.bin}"

SCENE_LABEL_FILE="${SCENE_LABEL_FILE:-$PROJECT_ROOT/data/ade20k/test/data_ip_test.json}"

cd "$PROJECT_ROOT"

python "$PROJECT_ROOT/image_generation.py" \
