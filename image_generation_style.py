...
from ip_adapter_with_style import IPAdapterStyle
...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help="Strength multiplier for the learned style token only.",
    )
    parser.add_argument(
        "--styles",
        type=list, 
...
def main(args):
    ...
    scale = args.scale
    style_token_scale = args.style_token_scale
    ...
    ip_model = IPAdapterStyle(pipe, image_encoder_path, ip_adapter_path, "cuda")
