...
RUN_NAME="${RUN_NAME:-$(date +%F)_ipadapter_sd15_controlnet97_100steps_scale0.8}"
...
IP_ADAPTER_PATH="${IP_ADAPTER_PATH:-$PROJECT_ROOT/ip_adapter_models/models/ip-adapter_sd15.bin}"
IP_ADAPTER_TYPE="${IP_ADAPTER_TYPE:-normal}"
...
echo "Running pretrained IP-Adapter generation/evaluation: $RUN_NAME"
echo "Adapter: $IP_ADAPTER_PATH"
echo "Adapter type: $IP_ADAPTER_TYPE"
